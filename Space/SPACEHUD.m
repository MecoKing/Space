...
-(void) updateFactionHUD {
	...
	hullNameLabel.text = [NSString stringWithFormat:(@"%@ - %luc"), self.faction.hullPart.name, (unsigned long) self.faction.hullPart.value];
	...
	wingNameLabel.text = [NSString stringWithFormat:(@"%@ - %luc"), self.faction.wingPart.name, (unsigned long) self.faction.wingPart.value];
	...
	thrusterNameLabel.text = [NSString stringWithFormat:(@"%@ - %luc"), self.faction.thrusterPart.name, (unsigned long) self.faction.thrusterPart.value];
